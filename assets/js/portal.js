...
const awhina = {
  ...
  instance: {
    configURI: "assets/projects/_project_config/PROJECT_portalconfig.json",
  ...
  map: {
    ...
    hoverProperty: "names_", // The field to show when hovering
...
function refreshListener(){
  ...
  if (typeof(Worker) !== "undefined") {
    ...
    awhina.data.worker = new Worker("assets/js/portal-worker.js");
